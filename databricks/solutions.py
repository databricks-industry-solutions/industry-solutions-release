...
class Accelerator:
    ...
    def export_to_html(self, local_dir):
        ...
        self.logger.info("db_objects : " + '\n'.join([str(x) for x in list(self.w.workspace.list("/Workspace/Users/srijit.nair@databricks.com/CareCost-Compass"))]))
        self.logger.info("db_objects : " + '\n'.join([str(x) for x in db_objects]))
